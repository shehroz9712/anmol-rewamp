...
class EventController extends Controller
{
    ...
    public function index()
    {
        ...
        $events = Event::where('user_id', Auth::id())->orderBy('date')->get();
    ...
    function calender($type = null)
    {
        ...
        // dd($appointments);
        return view('user.events.calender', compact('appointments', 'type'));
    }

    public function create()
    {
        $types = Type::all();
        return view('user.events.create', compact('types',));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('user.events.show', compact('journey', 'menu'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('user.events.edit', compact('event', 'eventId', 'types', 'occasions'));
    }
    ...
    function invoice(Request $request, $id)
    {
        ...
        $journey = Journey::where('eventid', $id)->with('event', 'venue', 'ServiceStyling', 'package')->firstOrFail();
        $menu = EventMenu::where('event_id', $journey->eventid)->with('dishes')->get();
        return view('user.events.invoice', compact('journey', 'menu'));
    }
    function print_invoice(Request $request, $id)
    {
        ...
        $pdf->loadHtml(view('user.events.invoice', compact('journey', 'menu')));
