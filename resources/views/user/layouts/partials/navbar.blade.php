    ...
    <div class="main-container container-fluid">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="{{ route('user.index') }}"><img src="../assets/img/brand/logo.png" height="50px"
                        class="mobile-logo" alt="logo"></a>
                <a href="{{ route('user.index') }}"><img src="../assets/img/brand/logo-light.png" height="50px"
                                    ...
                                    <div class="media {{ $notification->is_read ? '' : 'new' }}"
                                        ...
                                        <div class="align-items-center d-flex justify-content-around media-body ms-0">
                                            ...
                                            <div>
                                                ...
                                                <p class="fw-bold">
                                                    {{ Illuminate\Support\Str::limit($notification->subject, 20, '...') }}
                                                </p>
