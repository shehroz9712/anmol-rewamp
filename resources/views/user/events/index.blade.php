        ...
        <div class="page-header">
            ...
            <div class="d-flex">
                <div class="justify-content-center">
                    ...
                    <a href="{{ route('user.events.create') }}" class="btn btn-primary my-2 btn-icon-text">
                                ...
                                <tbody>
                                    @foreach ($events as $event)
                                        <tr>
                                            ...
                                            <td class="d-flex"> <a href="{{ route('user.events.show', encrypt($event->id)) }}"
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-light"
                                                            ...
                                                            @if ($event->journey->eventid)
                                                                <li><a class="dropdown-item "
                                                                        href="{{ route('user.events.edit', encrypt($event->journey->eventid)) }}">
                                                            ...
                                                            @if ($event->journey->menu_submit)
                                                                ...
                                                                @if (Auth::user()->Role == 'Admin')
                                                                    <li><a class="dropdown-item "
                                                                            href="{{ route('user.events.menu.edit.request', encrypt($event->journey->eventid)) }}">
                                                                            <i class="fa fa-pencil-alt"></i>
                                                                            Request Change items </a>
                                                                    </li>
                                                                @else
                                                                    <li><a class="dropdown-item "
                                                                            href="{{ route('user.events.menu.edit', encrypt($event->journey->eventid)) }}">
                                                                            <i class="fa fa-pencil-alt"></i>
                                                                            Change items </a>
                                                                    </li>
                                                                @endif
